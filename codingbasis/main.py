...
while flag:                     # starting a while loop so my program will keep working

    enter = input('Guess the random number between 1 and 100 : ')          # display msg to user to input a number and assing number to variable
